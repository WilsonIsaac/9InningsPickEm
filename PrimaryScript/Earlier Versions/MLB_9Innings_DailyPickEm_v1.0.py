...
print("3. Probable pitchers, stats, and weather data sourced from [mlb.com](https://www.mlb.com/) (via the [MLB-StatsAPI](https://pypi.org/project/MLB-StatsAPI/) and [Swish Analytics](https://swishanalytics.com/optimus/mlb/lineups?date=2020-08-01).  ")
print("4. Estimated chance of winning percentages sourced from [FiveThirtyEight’s 2020 MLB Game Predictions](https://projects.fivethirtyeight.com/2020-mlb-predictions/games/).  ")
print("  ")
print("&nbsp;")
print("  ")
print("Our thoughts go out to all individuals affected by the COVID-19 pandemic, and we hope for full recoveries for the players and staff infected. We will try to include updates as information is made known; however, there is obviously a great deal of uncertainty, so details such as probable pitchers, winning odds, and match certainty are (even more than usual) subject to change. Note that cancelled games (weather or other reasons) are automatically counted as correct guesses, but not all games have been included as available selections the last couple days (due to cancellations and late-rescheduling).  ")
print('*****')
print('*****')
print('*****')
